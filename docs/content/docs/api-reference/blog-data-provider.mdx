...
<AutoTypeTable path="../src/lib/better-blog/core/types.ts" name="BlogDataProvider" />

### BlogDataProviderConfig
Data providers typically have a config object that is passed to the data provider factory function.

<AutoTypeTable path="../src/lib/better-blog/core/types.ts" name="BlogDataProviderConfig" />
