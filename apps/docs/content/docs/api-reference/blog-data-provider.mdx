...
<AutoTypeTable path="../../packages/better-blog/src/types/index.ts" name="BlogDataProvider" />

### BlogDataProviderConfig
Data providers typically have a config object that is passed to the data provider factory function.

<AutoTypeTable path="../../packages/better-blog/src/types/index.ts" name="BlogDataProviderConfig" />
