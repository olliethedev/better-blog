...
export default {
    ...
    testPathIgnorePatterns: [
        ...
        "<rootDir>/src/providers/__tests__/common-provider-tests.ts",
        "<rootDir>/src/providers/__tests__/migrations",
        "<rootDir>/src/providers/__tests__/test-options.ts",
        "<rootDir>/src/providers/__tests__/prisma/get-prisma.ts",
        "<rootDir>/src/providers/__tests__/prisma/push-prisma.ts"
    ],
    testMatch: [
